namespace TaskManagement.Web
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IISTasksService, ISTasksService>();
        }
